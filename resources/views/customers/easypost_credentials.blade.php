                                ...
                                <div class="table-responsive table-overflow items-table mb-4">
                                    <table class="col-12 table align-items-center table-flush">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">{{ __('Customs signer') }}</th>
                                            <th scope="col">{{ __('Contents type') }}</th>
                                            <th scope="col">{{ __('Contents explanation') }}</th>
                                            <th scope="col">{{ __('EEL/PFC') }}</th>
                                            <th scope="col"></th>
                                        </tr>
                                        </thead>
                                        ...
                                        @foreach($customer->easypostCredentials as $easypostCredential)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $easypostCredential->customs_signer }}
                                                </td>
                                                <td>
                                                    {{ $easypostCredential->contents_type }}
                                                </td>
                                                <td>
                                                    {{ $easypostCredential->contents_explanation }}
                                                </td>
                                                <td>
                                                    {{ $easypostCredential->eel_pfc }}
                                                </td>
                                                <td>
